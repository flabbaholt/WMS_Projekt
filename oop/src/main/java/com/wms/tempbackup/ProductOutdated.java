...
//ACHTUNG: WIRD NICHT MEHR BENUTZT - ProductSearchModel wird benutzt
public class ProductOutdated implements Displayable{
    // attributes
    private int id;
    ...
    // constructer
    public ProductOutdated(int id, int stellplatz_id, String productName, String manufacturer, String arrivalTime) {
        this.id = id;
